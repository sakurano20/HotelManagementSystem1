...
def get_db():
    ...
    if missing:
        app.logger.warning(f"Missing env vars: {missing}")
        return None

    ssl_params = None
    if os.path.exists("ca.pem"):
        ssl_params = {"ca": "ca.pem"}
    ...
    try:
        ...
        app.logger.warning(f"DB connection failed: {e}")
        db = None
...
def do_login():
    ...
    if connection is None:
        return "Database unavailable. <a href='/login'>Try again</a>"
