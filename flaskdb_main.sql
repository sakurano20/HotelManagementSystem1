...
CREATE TABLE IF NOT EXISTS `checkins` (
  ...
  `status` enum('checked-in','checked-out') COLLATE utf8mb4_general_ci DEFAULT 'checked-in',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `total_price` decimal(10,2) DEFAULT '0.00',
  `downpayment_amount` decimal(10,2) DEFAULT '0.00',
  `remaining_balance` decimal(10,2) DEFAULT '0.00',
  `payment_status` enum('unpaid','partial','fully_paid') COLLATE utf8mb4_general_ci DEFAULT 'unpaid',
  PRIMARY KEY (`id`),
  KEY `room_id` (`room_id`),
...
CREATE TABLE IF NOT EXISTS `foods` (
  ...
  `name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `price` decimal(10,2) NOT NULL,
  `category` enum('drinks','appetizers','mains','desserts') COLLATE utf8mb4_general_ci DEFAULT 'mains',
  `available` tinyint(1) DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `food_orders` (
  ...
  `status` enum('pending','prepared','delivered') COLLATE utf8mb4_general_ci DEFAULT 'pending',
  PRIMARY KEY (`id`),
  KEY `checkin_id` (`checkin_id`)
...
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  `payment_type` enum('cash','card','transfer') COLLATE utf8mb4_general_ci DEFAULT 'cash',
...
CREATE TABLE IF NOT EXISTS `rooms` (
  ...
  `type` enum('single','double','suite') COLLATE utf8mb4_general_ci DEFAULT 'single',
  `price` decimal(10,2) NOT NULL,
  `status` enum('available','occupied','maintenance') COLLATE utf8mb4_general_ci DEFAULT 'available',
  `image` varchar(800) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
